...
function initWindow(){
 ...
 // clear background with white color
  ...
  text('Create Your Own Ice Cream!', 300, 100);
  ...
  textFont('Georgia');
  textAlign(CENTER, CENTER);
  text('⬇️ Choose a color of your ice cream. ⬇️', 300, 130);
